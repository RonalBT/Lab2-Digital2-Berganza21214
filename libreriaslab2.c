/*
 * File:   libreriaslab2.c
 * Author: Ronal
 *
 * Created on 24 de julio de 2023, 11:52 PM
 */


#include <xc.h>
#include <stdint.h>
#include "headerlibreriaslab2.h"
...
void InterruptADC(char* LowNibble_ADC, char* HighNibble_ADC){
    if (ADIF == 1){
        ...
        Low_ADC = ADRESL;
        Low_ADC = (Low_ADC & 0b11111100) >> 2; //borramos los dos primeros bits de ADRESL y los movemos
